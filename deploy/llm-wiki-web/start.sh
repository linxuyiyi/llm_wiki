...
UPSTREAM_CONNECT_TIMEOUT="${LLM_WIKI_UPSTREAM_CONNECT_TIMEOUT_SECONDS:-30}"
UPSTREAM_TIMEOUT="${LLM_WIKI_UPSTREAM_TIMEOUT_SECONDS:-600}"

export LLM_WIKI_UPSTREAM_CONNECT_TIMEOUT_SECONDS="$UPSTREAM_CONNECT_TIMEOUT"
export LLM_WIKI_UPSTREAM_TIMEOUT_SECONDS="$UPSTREAM_TIMEOUT"
...
echo "LLM upstream timeout: connect=${UPSTREAM_CONNECT_TIMEOUT}s request=${UPSTREAM_TIMEOUT}s"
